...
module AccountManager : AccountManager = struct 
  ...
  let set_account_balance (m: t) (username: string) (t: string) (a: float) = 
  ...
  let inc_account_balance (m: t) (username: string) (t: string) (a: float) = 
    let (account, _) = D.find m username in 
    let cur_balance = Account.balance account t in 
    let new_balance = cur_balance +. a in 
    Account.set_balance account t new_balance

  let dec_account_balance (m: t) (username: string) (t: string) (a: float) = 
    let (account, _) = D.find m username in 
    let cur_balance = Account.balance account t in 
    let new_balance = cur_balance -. a in 
    Account.set_balance account t new_balance
